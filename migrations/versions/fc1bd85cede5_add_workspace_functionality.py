...
def upgrade() -> None:
    ...
    if users:
        ...
        functions_result = connection.execute(sa.text("""
    ...
    op.create_foreign_key('fk_functions_workspace_id', 'functions', 'workspaces', ['workspace_id'], ['id'])
    op.create_index(op.f('ix_functions_workspace_id'), 'functions', ['workspace_id'], unique=False)
