...
def create_workspace_token(workspace_id: uuid.UUID, expires_delta: Optional[timedelta] = None) -> str:
    """
    Workspace 인증 토큰 생성
    ...
    if expires_delta:
        ...
        expire = datetime.utcnow() + timedelta(hours=24)  # 워크스페이스 토큰은 24시간 유효
